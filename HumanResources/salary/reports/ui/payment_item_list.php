...
if (isset($_REQUEST["show"])) {
	...
	$query = "		
                        ...
                        SUM(if( sit.salary_item_type_id in (13,14,15,16,42,46,47,48,21,22) , (pit.pay_value + pit.diff_pay_value * pit.diff_value_coef) , 0  )) item24 ,
                        ...
                        SUM(if( sit.salary_item_type_id in ( 16,42,46,47,48 ) , (pit.pay_value + pit.diff_pay_value * pit.diff_value_coef) , 0  )) item3_1 ,
                        SUM(if( sit.salary_item_type_id in ( 16,42,46,47,48 ) , pit.param2 , 0  )) Pitem3_1 ,
                        ...
                        SUM(if( sit.salary_item_type_id in ( 36 , 13 ) , (pit.pay_value + pit.diff_pay_value * pit.diff_value_coef) , 0  )) item4_4 ,
                        ...
                        SUM(if( sit.salary_item_type_id in ( 39 , 15 )  , (pit.pay_value + pit.diff_pay_value * pit.diff_value_coef) , 0  )) item4_7 ,
